      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-block">
            ...
            <p>
              <a href="https://en.wikipedia.org/wiki/Earthquake" className="btn btn-danger mt-3">
                Learn More
              </a>
            </p>
          </div>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-caption d-none d-md-block">
            <h5>Flood</h5>
            <p>
              <a href="https://en.wikipedia.org/wiki/Flood" className="btn btn-danger mt-3">
                Learn More
              </a>
            </p>
          </div>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-caption d-none d-md-block">
            ...
            <p>
              <a href="https://en.wikipedia.org/wiki/Wildfire" className="btn btn-danger mt-3">
                Learn More
              </a>
            </p>
          </div>
